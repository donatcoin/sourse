...
uint256 hashGenesisBlock("0x0ad1b192148b1abe73a50a4f65f95c787ec94fbc785a0a0d11c30642868e87e1");
...
const string strMessageMagic = "DonatCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // DonatCoin: 1 days
static const int64 nTargetSpacing = 120; // DonatCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal donatcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "DonatCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xa8c5ed4f3f161dd254717619f2a34bc02a3f4277f9d3bab5009eba971521219e");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Donatcoin: 16.07.2017 - botanik26rus";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1500198355; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2754756;

        if (fTestNet)
        {
            block.nTime    = 1500195912;
            block.nNonce   = 827163;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xb1567953347db3e66515c243d17e2ece926fb8a4964016f483828ded38434ec1"));
